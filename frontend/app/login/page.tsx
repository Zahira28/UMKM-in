...
export default function LoginPage() {
  ...
  const [emailOrUsername, setEmailOrUsername] = useState('nama@email.com');
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f6f8f5]">
      ...
      <div className="w-full md:w-1/2 p-6 md:p-12 flex items-center justify-center">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-gray-100 space-y-6">
          <div>
            <h2 className="text-2xl font-extrabold text-gray-900 tracking-tight">
              Selamat datang kembali
            </h2>
            <p className="text-xs text-gray-500 mt-1">
              Masuk untuk melanjutkan menjelajahi produk lokal.
            </p>
          </div>
          ...
          <p className="text-center text-xs text-gray-600 pt-2">
            Belum punya akun?{' '}
            <Link href="/signup" className="text-[#138a53] font-bold hover:underline">
              Daftar
            </Link>
          </p>
        </div>
